...
import { BrowserPreviewIcon, DiffIcon, FileIcon, TerminalIcon } from "./icons";
...
export function Topbar(props: TopbarProps) {
  ...
  // getDesktopShortcutLabel only prefixes a single key; Shift+B needs a manual chord.
  const browserShortcut = api.platform === "darwin" ? "⌘⇧B" : "Ctrl+Shift+B";
    ...
    <header className="topbar" data-testid="topbar" onDoubleClick={handleDoubleClick}>
      ...
      <div className="topbar__actions">
        ...
        <TopbarActionButton
          ...
          disabled={!browserAvailable || !onToggleBrowser}
