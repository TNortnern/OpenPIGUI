...
export const desktopIpc = {
  ...
  setRightRailState: "pi-gui:set-right-rail-state",
  ...
  browserEnsure: "pi-gui:browser-ensure",
  browserNavigate: "pi-gui:browser-navigate",
  browserBack: "pi-gui:browser-back",
  browserForward: "pi-gui:browser-forward",
  ...
  browserOpenExternal: "pi-gui:browser-open-external",
  browserSelectSession: "pi-gui:browser-select-session",
  browserDestroy: "pi-gui:browser-destroy",
  browserStateChanged: "pi-gui:browser-state-changed",
...
export function getDesktopCommandFromShortcut(input: DesktopShortcutInput): PiDesktopCommand | undefined {
  ...
  const isShiftB = input.shift && isB;
  ...
  if (isShiftB) {
    return desktopCommands.toggleBrowser;
  }
...
export interface PiDesktopApi {
  ...
  setRightRailState(preferences: RightRailPreferences): Promise<DesktopAppState>;
  ...
  ensureBrowserPanel(target: BrowserTarget): Promise<BrowserStateSnapshot>;
  navigateBrowser(input: BrowserNavigateInput): Promise<BrowserStateSnapshot>;
  browserBack(target: BrowserTarget): Promise<BrowserStateSnapshot>;
  browserForward(target: BrowserTarget): Promise<BrowserStateSnapshot>;
  ...
  openBrowserExternal(): Promise<void>;
  destroyBrowser(): Promise<void>;
  onBrowserStateChanged(listener: (state: BrowserStateSnapshot) => void): () => void;
  ensureTerminalPanel(
    workspaceId: string,
