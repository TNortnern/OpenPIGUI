...
import type { RightRailPreferences } from "./right-rail-model";
import { createDefaultRightRailPreferences } from "./right-rail-model";
...
export interface DesktopAppState {
  ...
  readonly rightRail: RightRailPreferences;
...
export function createEmptyDesktopAppState(): DesktopAppState {
  return {
    ...
    rightRail: createDefaultRightRailPreferences(),
