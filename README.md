...
OpenPIGUI is in public beta (**0.1.0-beta.46**) for **macOS (Apple Silicon)** and **Linux (AppImage)**.
...
(beta builds are marked **Pre-release** — choose **0.1.0-beta.46**):

- **macOS:** [OpenPIGUI-0.1.0-beta.46-arm64.dmg](https://github.com/TNortnern/OpenPIGUI/releases/download/v0.1.0-beta.46/OpenPIGUI-0.1.0-beta.46-arm64.dmg) (or the matching `.zip` for auto-update)
- **Linux:** [OpenPIGUI-0.1.0-beta.46-x86_64.AppImage](https://github.com/TNortnern/OpenPIGUI/releases/download/v0.1.0-beta.46/OpenPIGUI-0.1.0-beta.46-x86_64.AppImage)
- **Windows:** `.exe` installer when published on the release

Direct release: [v0.1.0-beta.46](https://github.com/TNortnern/OpenPIGUI/releases/tag/v0.1.0-beta.46).
