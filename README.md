...
OpenPIGUI is in public beta (**0.1.0-beta.36**) for **macOS (Apple Silicon)** and **Linux (AppImage)**.
...
(beta builds are marked **Pre-release** — choose **0.1.0-beta.36**):

- **macOS:** `OpenPIGUI-0.1.0-beta.36-arm64.dmg` (or the matching `.zip` for auto-update)
- **Linux:** `OpenPIGUI-*-linux-*.AppImage` when published on the release
- **Windows:** `.exe` installer when published on the release

Direct release: [v0.1.0-beta.36](https://github.com/TNortnern/OpenPIGUI/releases/tag/v0.1.0-beta.36).
